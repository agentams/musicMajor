...
public class Jiosavan extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_jiosavan);
        if (isOnline()) {
            ...
            webView.setWebViewClient(new Jiosavan.myWebViewClient());
            ...
            try {
                new AlertDialog.Builder(Jiosavan.this)
                        .setTitle("Error")
